 ...
 */
define( 'AYS_QUIZ_NAME_VERSION', '21.7.2' );
define( 'AYS_QUIZ_VERSION', '21.7.2' );
         ...
         <div class="ays-notice-banner">
            <div class="navigation-bar">
                <div id="navigation-container">
                    ...
                    <ul id="menu">
                        <li class="modile-ddmenu-lg"><a class="ays-btn" href="https://ays-pro.com/wordpress-quiz-maker-user-manual" target="_blank"><?php echo __( "Documentation", AYS_QUIZ_NAME ); ?></a></li>
                        <li class="modile-ddmenu-xs"><a class="ays-btn" href="https://wordpress.org/support/plugin/quiz-maker/reviews/?rate=5#new-post" target="_blank"><?php echo __( "Rate Us", AYS_QUIZ_NAME ); ?></a></li>
...
<!--                        <li class="modile-ddmenu-xs take_survay"><a class="ays-btn" href="http://bit.ly/2tLbooO" target="_blank">Take a survey</a></li>-->
                        ...
                        <li class="modile-ddmenu-md">
                            ...
                            <ul class="ddmenu" data-expanded="false">
                                <li><a class="ays-btn" href="https://ays-pro.com/wordpress-quiz-maker-user-manual" target="_blank"><?php echo __( "Documentation", AYS_QUIZ_NAME ); ?></a></li>
                                <li><a class="ays-btn" href="https://wordpress.org/support/plugin/quiz-maker/reviews/?rate=5#new-post" target="_blank"><?php echo __( "Rate Us", AYS_QUIZ_NAME ); ?></a></li>
