...
class Question_Tags_List_Table extends WP_List_Table{
    ...
    protected function get_views() {
        ...
        $status_links = array(
            ...
            "published" => "<a ".$selected_1." href='?page=".esc_attr( $_REQUEST['page'] )."&fstatus=published'>". __( 'Published', $this->plugin_name )." (".$published_count.")</a>",
            "unpublished"   => "<a ".$selected_0." href='?page=".esc_attr( $_REQUEST['page'] )."&fstatus=unpublished'>". __( 'Unpublished', $this->plugin_name )." (".$unpublished_count.")</a>"
        );
