...
class All_Reviews_List_Table extends WP_List_Table{
    ...
    public function extra_tablenav( $which ){
        ...
        <div id="quiz-filter-div-<?php echo $which; ?>" class="alignleft actions bulkactions">
            ...
            <input type="button" id="doaction-<?php echo $which; ?>" class="review-page-quiz-filter-apply-<?php echo $which; ?> button" value="<?php echo __( "Filter", $this->plugin_name ); ?>">
        </div>
    ...
    public static function get_where_condition(){
        ...
        if( isset( $_REQUEST['filterby'] ) && sanitize_text_field( $_REQUEST['filterby'] ) > 0){
