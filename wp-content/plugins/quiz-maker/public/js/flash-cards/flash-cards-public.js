(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(document).find('.ays-quiz-flash-card-rotate').on('click', function() {
            var aysQuizQuestion = $(this).parent().find('.ays_quiz_front');
            var aysQuizAnswer   = $(this).parent().find('.ays_quiz_back');
