            ...
            <div class="ays-quiz-tabs-wrapper">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <div class="d-none" id="googleInstructions">
                                            <ol style="font-size:15px;">
                                                <li><?php echo __('Enable Your Google Sheet API from your Google Cloud Platform', $this->plugin_name); ?>:
                                                    <a href="https://console.developers.google.com" target="_blank">https://console.developers.google.com</a>.
                                                </li>
                                                <li><?php echo __('Follow the instructions and create credentials in case if you still do not have them. (Make sure you have got a project and it is active. If you don’t you will have to create a project).', $this->plugin_name); ?>
                                                    <ul style="list-style-type: initial; padding-left: 40px;margin: 11px 0;">
                                                        <li>
                                                            <a href="https://console.developers.google.com/apis/credentials" target="_blank"><?php echo __('Create', $this->plugin_name); ?></a> <?php echo __('new OAuth client ID credentials', $this->plugin_name); ?>.
                                                        </li>
                                                        <li>
                                                            <?php echo __('Choose the application type as <b>Web application</b>', $this->plugin_name); ?>
                                                        </li>
                                                        <li>
                                                            <?php echo __('Add the following link in the <b>Authorized redirect URIs</b> field', $this->plugin_name); ?>
                                                        ...
                                                        <li>
                                                            <?php echo __('Click on the <em>Create</em> button.', $this->plugin_name); ?>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li><?php echo __('After the successful authorization, copy <b>Your Client ID</b> and <b>Your Client Secret</b> and paste them into corresponding fields.', $this->plugin_name); ?></li>
                                                <li><?php echo __('Click on the Connect button', $this->plugin_name); ?></li>
                                                <li><?php echo __('Choose your Google account. Make sure you have given access to the <em>See, edit, create, and delete your Google Sheets spreadsheets</em> by ticking the checkbox.', $this->plugin_name); ?></li>
                                            </ol>
                ...
                <div id="tab3" class="ays-quiz-tab-content <?php echo ($ays_quiz_tab == 'tab3') ? 'ays-quiz-tab-content-active' : ''; ?>">
                    ...
                    <fieldset>
                        <legend>
                            <strong style="font-size:30px;">[ ]</strong>
                            <h5 class="ays-subtitle"><?php echo __('User Leaderboard Postion Settings',$this->plugin_name)?></h5>
                        </legend>
                        <div class="form-group row">
                            <div class="col-sm-4">
