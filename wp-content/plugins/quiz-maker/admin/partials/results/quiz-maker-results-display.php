...
<div class="wrap ays_results_table">
    ...
    <div class="question-action-butons">
        ...
        <a class="xuatfilecustom" id = 'xuatfilecustom' style="float: right;"><?php echo __('Export', $this->plugin_name); ?></a>
    </div>
...
<script>
    const xuatfilecustom = document.querySelector('#xuatfilecustom');
    xuatfilecustom.addEventListener('click',function () {
        jQuery.ajax({
            url: '<?= str_replace("\\","/",get_site_url())?>/wp-content/plugins/quiz-maker/admin/partials/results/apicustomfile.php',
            type: "POST",
            async: true,
            data: {"all":""},
