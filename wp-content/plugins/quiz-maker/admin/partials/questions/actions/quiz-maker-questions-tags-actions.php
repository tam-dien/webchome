...
//Tag Description
$description = (isset($question_tag['description']) && $question_tag['description'] != '') ? htmlentities( $question_tag['description'] ) : '';
    ...
    <div class="container-fluid">
        ...
        <form class="ays-quiz-tag-form" id="ays-quiz-tag-form" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input class='ays-text-input' id='ays_quiz_question_tags_title' name='ays_quiz_question_tags_title' type='text' value='<?php echo $title; ?>'>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="form-check form-check-inline" >
                        <input type="radio" id="ays_quiz_questio_tag_status_publish" name="ays_quiz_quetion_tag_status" value="published" <?php echo $status == 'published' ? 'checked' : ''; ?>/>
                        <label class="form-check-label" for="ays_quiz_questio_tag_status_publish"> <?php echo __('Published', $this->plugin_name); ?> </label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input type="radio" id="ays_quiz_questio_tag_status_unpublish" name="ays_quiz_quetion_tag_status" value="unpublished" <?php echo $status == 'unpublished' ? 'checked' : ''; ?>/>
